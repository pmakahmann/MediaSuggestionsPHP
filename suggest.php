...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!isset($error_message)) {
        ...
        $mail->addAddress('rk@roguemiddlechild.com', 'Alena');     // Add a recipient
    ...
    <div class="wrapper">
        ...
        <?php if (isset($_GET["status"]) && $_GET["status"] == "thanks") {
            ...
            if (isset($error_message)) {
                ...
                echo "<p>If you think there is something I should read, watch or listen to, let me know! Complete the form to send me an email.</p>";
            }
        ?>
